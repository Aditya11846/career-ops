import { LayoutDashboard, Compass, ListChecks, Radar, BarChart3, FileText, Settings, UserSearch } from "lucide-react";
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/senior-search", label: "Dad's Search", icon: UserSearch, chip: "New" },
